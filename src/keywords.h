...
enum keyWords
{
    ...
    JDATE, JPL_FILE, 
    LABEL, LABELPOS, LABEL_STRING, LAMBERT, LATITUDE, LATLON, LBR, LEFT, LIGHT_TIME, LOCALTIME, LOGMAGSTEP, LONGITUDE, 
    ...
    SATELLITE_FILE, SAVE_DESKTOP_FILE, SEARCHDIR, SHADE, SPACING, SPECULAR_MAP, STARFREQ, STARMAP, SYMBOLSIZE, SYSTEM, 
